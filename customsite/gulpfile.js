...
// Serve Task
gulp.task('serve', ['browser-sync', 'lazy-rules', 'import-modules', 'css', 'watch']);
...
gulp.task('build', function() {
	runSequence('clean:build', 'lazy-rules', 'import-modules', 'css', 'sprites', 'copy:build', 'include:build', 'optimise:images', 'zip:build');
});
...
function getSelectorToken(file) {
	...
	var prefixRegex = /^_module(?!(\.form\-elements|\.list))|^_region/gi;
	var token       = null;
